...
{
    public partial class historia41 : Form
    {
        Inimigo inimigo01 = new Inimigo(8, 7);
        ...
        private int morreu()
        {
            ...
            label7.Text = "Wilhelm Hyedrich = " + dadoInimigo0101.ToString() + " - " + dadoInimigo0102.ToString();
