...
{
    public partial class historia21 : Form
    {
        Inimigo inimigo01 = new Inimigo(8, 6);
        ...
        private int morreu()
        {
            ...
            label7.Text = "Gnomo = " + dadoInimigo0101.ToString() + " - " + dadoInimigo0102.ToString();
