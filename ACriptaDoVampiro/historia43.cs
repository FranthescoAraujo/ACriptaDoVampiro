...
{
    public partial class historia43 : Form
    {
        Inimigo inimigo01 = new Inimigo(7, 6);
        ...
        private int morreu()
        {
            ...
            label7.Text = "Corvo = " + dadoInimigo0101.ToString() + " - " + dadoInimigo0102.ToString();
